...
import EditFormStaff from './views/pages/pageManageStaff/EditFormStaff'
import Product from './views/pages/product/Product'
import Staff from './views/pages/pageManageStaff/Staff'
import ProductForm from './views/pages/product/ProductForm'
import StaffForm from './views/pages/pageManageStaff/StaffForm'
...
const routes = [
  ...
  { path: '/staff', name: 'Quản lý nhân viên', component: Staff, exact: true },
  { path: '/staff/add', name: 'Thêm nhân viên', component: StaffForm, exact: true },
  { path: '/staff/:slug', name: 'Sửa sản phẩm', component: EditFormStaff, exact: true },
